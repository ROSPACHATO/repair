...
window.addEventListener("resize", function (e) {
  if (window.innerWidth < 600) {
    ...
    hide.forEach(item => item.style.display = "");
  }
});
...
const menu = ["Rostov-on-Don, Admiral", "Sochi Thieves", "Rostov-on-Don Patriotic"];
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".project__right-swiper", {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Controller],
  slidesPerView: 1,
  ...
  //бесконечный слайдер
  allowTouchMove: true,
  // отключение возможности перетаскивания на пк
  ...
  pagination: {
    ...
    clickable: true,
    // возможность нажимать на буллеты
  ...
  scrollbar: {
    el: ".swiper-scrollbar",
    draggable: true,
    //возмоность перемещаться мышкой
    dragSize: 260 //ширина ползунка
  },

  autoplay: {
    // delay: 1000,
    disableOnInteraction: false,
    // автовоспроизведение не будет отключено после взаимодействия пользователя
    pauseOnMouseEnter: true // останавливает автовоспроизведение при вводе мыши на слайдер
  },
...
const swiperInfo = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".project__info-swiper", {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Controller],
  loop: false,
  //бесконечный слайдер
...
const TabItemSelector = ".galary__tab-item";
const ContentItemSelector = ".galary__content-item";
class TabsManager {
  constructor(navNode) {
    this.tabs = [];
    this.activeTab = null;
...
document.addEventListener("DOMContentLoaded", () => {
  let tabs = new TabsManager(document.querySelector(".galary"));
});
...
// im.mask(telSelector);
// telSelector.addEventListener("focus", function (e) {
//   console.log("hi");
// });
...
//         rule: "minLength",
//         value: 7,
//         errorMessage: "Invalid 232323",
//       },
//       {
//         rule: "required",
//         errorMessage: "шото не так",
//       },
//     ],
//   },
...
validation.addField(".form__input", [{
  rule: "minLength",
  value: 6,
...
/***/ "./src/js/components/yandex_map.js":
/*!*****************************************!*\
  !*** ./src/js/components/yandex_map.js ***!
  \*****************************************/
/***/ (() => {
...
function init() {
  let map = new ymaps.Map("map", {
    center: [51.702803696410975, 39.176364241623666],
    zoom: 16
  });
  let placemark = new ymaps.Placemark([51.702803696410975, 39.176364241623666]);
...
/* harmony import */ var _components_yandex_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/yandex_map */ "./src/js/components/yandex_map.js");
/* harmony import */ var _components_yandex_map__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_yandex_map__WEBPACK_IMPORTED_MODULE_3__);
